...
##### save to sql #####
samsung = datasaku_sqlalchemy.sqlalchemy_class(username = 'postgres', port = 5555)
samsung.execute_create_database('samsung')
samsung = datasaku_sqlalchemy.sqlalchemy_class(username = 'postgres', port = 5555, database = 'samsung')
